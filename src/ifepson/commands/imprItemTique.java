...
public class imprItemTique extends ifCommand {
    ...
    public void setCalificadorLetra(String letra) {
        params.put(Parametro.IIT__CALIF_ITEM, letra);
    }
    ...
    public void setCantidad(double cantidad) {
        int parteEntera = (new Double(cantidad)).intValue();
        int decimales = (new Double((cantidad * 1000) - (parteEntera * 1000))).intValue();
        this.params.put(Parametro.IIT__CANT_UNIDADES, GeneralFunc.stringFormat("{0:00000}{1:000}", parteEntera, decimales));
    }
    ...
    public void setPrecioUnitario(double precioUnitario) {
        int parteEntera = (new Double(precioUnitario)).intValue();
        int decimales = (new Double((precioUnitario * 10000) - (parteEntera * 10000))).intValue();
        this.params.put(Parametro.IIT__PRECIO_UNITARIO, GeneralFunc.stringFormat("{0:0000000}.{1:0000}", parteEntera, decimales));
    }
