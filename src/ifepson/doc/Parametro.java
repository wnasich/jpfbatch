...
public enum Parametro {
    ...
    IIT__CANT_UNIDADES         (601, imprItemTique.class, DataType.Num3Dec,      8, "Cantidad de unidades. (nnnnn.nnn) Nota: Manejo de 5 enteros y 3 decimales, se debe enviar sin el punto.", 1, "cantidad"),
    IIT__PRECIO_UNITARIO        (602, imprItemTique.class, DataType.Num4Dec,      12, "Precio Unitario del Item. (nnnnnnn.nnnn) Nota 1: Manejo de 7 enteros y 4 decimales, se debe enviar con el punto decimal. Nota 2: Compatible con manejo de 2 decimales (nnnnnnn.nn), en este caso se debe enviar 7 enteros y 2 decimales sin el punto decimal.", 2, "precioUnitario"),
    IIT__TASA_IMPOSITIVA         (603, imprItemTique.class, DataType.Num2Dec,      4, "Tasa Impositiva. Alícuota de IVA (nn.nn) Nota: Se envía sin el punto decimal, por ejemplo 21,00 % de IVA se debe enviar “2100”.", 3, "iva"),
    IIT__CALIF_ITEM               (604, imprItemTique.class, DataType.Alfa,       1, "Calificador de Item de Línea: 'M'= 0x4d, Monto agregado de mercadería o ítem de venta, SUMA. 'm'= 0x6d, anula el ítem vendido, RESTA. 'R'= 0x52, Bonificación, RESTA. 'r'= 0x72, anula una Bonificación, SUMA En el caso de Bonificación, se antepone automáticamente la leyenda “BONIF.” a la descripción del artículo. ", 4, "calificadorLetra"),
    IIT__CANTIDAD_BULTOS       (605, imprItemTique.class, DataType.Integer,   5, "Unidades o Bultos Vendidos. (nnnnn.)", 5, "bultos"),
    IIT__TASA_AJUSTE_VAR        (606, imprItemTique.class, DataType.Num8Dec,     8, "Tasa de Ajuste Variable. (.nnnnnnnn) Nota: Se debe enviar sólo los decimales, hasta 8 dígitos, sin el punto. Ver documentación de modelos anteriores por detalles del cálculo.", 6, "tasaAjusteVariable"),
    IIT__IMPUESTO_INTERNO      (607, imprItemTique.class, DataType.Num8Dec,     15, "Monto Impuestos Internos Fijos. <nnnnnnn.nnnnnnnn>", 7, "montoImpuestoInterno"),
    ...
    PDRC__MONTO               (701, pagoCancelDescRecaTique.class, DataType.Num2Dec,      9, "Monto de Pago / Descuento / Recargo (nnnnnnnnn.nn) Nota: Manejo de 9 enteros y 2 decimales, se debe enviar sin el punto", 1, "monto"),
    ...
    IIFNC__CANT_UNIDADES      (1901, imprItemFNC.class, DataType.Num3Dec,     8, "Cantidad de unidades. (nnnnn.nnn) Nota: Manejo de 5 enteros y 3 decimales, se debe enviar sin el punto.", 1, "cantidad"),
    ...
    IIFNC__TASA_IVA             (1903, imprItemFNC.class, DataType.Num2Dec,     4, "Tasa Impositiva. Alícuota de IVA (nn.nn) Nota: Se envía sin el punto decimal, por ejemplo 21,00 % de IVA se debe enviar “2100”.", 3, "iva"),
    ...
    PDRTCFNC__MONTO          (2101, pagoCancelDescRecaFNC.class, DataType.Num2Dec,      11, "Monto del Pago / Descuento / Recargo (nnnnnnnnn.nn) Nota: Manejo de 9 enteros y 2 decimales, se debe enviar sin el punto.", 1, "monto"),
    ...
    EDF__NRO_LINEA            (2400, setDatoFijo.class, DataType.Integer, 5, "Número de Línea de Datos Fijos de encabezado o cola", 0, "nroLinea"),
    EDF__DATOS_FIJOS         (2401, setDatoFijo.class, DataType.Alfa, 40, "Datos Fijos: Hasta 40 bytes de Texto Fiscal", 1, "datoFijo"),
    ELC__NRO_LINEA           (2500, setLineaCola.class, DataType.Integer, 3, "Número de Línea de Datos de cola", 0, "nroLinea"),
    ELC__LINEA_COLA         (2501, setLineaCola.class, DataType.Alfa, 40, "Datos Fijos: Hasta 40 bytes de Texto No Fiscal", 1, "lineaCola");
    ...
    Parametro(int codigo, Class comando, DataType type, int largo, String descripcion, Integer indice, String propName) {
        this.codigo = codigo;
        this.type = type;
        this.largo = largo;
        this.descripcion = descripcion;
        this.indice = indice;
        this.comando = comando;
        this.paramSetter = ReflectionFunc.getSetterMethod(comando, propName);
    }
